...
class LockProductFacadeTest {

    private final ProductRepository productRepository;
    private final LockProductFacade spinlockProductFacade;

    @Autowired
    LockProductFacadeTest(final ProductRepository productRepository,
                          final LockProductFacade spinlockProductFacade) {
